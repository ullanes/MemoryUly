...
class CreateActivity : AppCompatActivity() {
    ...
    override fun onRequestPermissionsResult(
        ...
        if(requestCode == READ_EXTERNAL_PHOTOS_CODE){
            if(grantResults.isNotEmpty() && grantResults[0] == PackageManager.PERMISSION_GRANTED){
                ...
                Toast.makeText(this, "In order to create custom game our app needs your permission to access", Toast.LENGTH_LONG)
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if(requestCode != PICK_PHOTO_CODE || resultCode!= Activity.RESULT_OK || data == null){
            Log.w(TAG, "Did not get back data from launched activity, user likely canceled")
            return
        }
    ...
    private fun saveDataToFirebase() {
        ...
        //CHECK IF NOT OVERRIDDING OTHER GAME
        db.collection("games").document(customGameName).get().addOnSuccessListener { document->
            ...
            Log.e(TAG,"Encountered error while saving", exception)
            Toast.makeText(this, "Encountered error while saving", Toast.LENGTH_LONG).show()
        }
    ...
    private fun handleAllImagesUploaded(gameName: String, imageUrls: MutableList<String>) {
        db.collection("games").document(gameName)
                ...
                .addOnCompleteListener{gameCreationTask->
                    ...
                    Log.i (TAG, "Successfully created gagme $gameName")
                    AlertDialog.Builder(this)
                            .setTitle("Upload complete! Let's play your '$gameName'")
